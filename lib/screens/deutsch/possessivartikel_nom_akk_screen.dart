...
class PossessivartikelNomAkkScreen extends StatefulWidget {
  const PossessivartikelNomAkkScreen({super.key});

  @override
  State<PossessivartikelNomAkkScreen> createState() =>
      _PossessivartikelNomAkkScreenState();
}

class _PossessivartikelNomAkkScreenState extends State<PossessivartikelNomAkkScreen>
    with SingleTickerProviderStateMixin {
  late TabController _tabs;
  late List<PossessivartikelNomAkkFrage> _queue;
  ...
  void initState() {
    ...
    _queue = List<PossessivartikelNomAkkFrage>.from(allPossessivartikelNomAkkFragen());
  ...
  PossessivartikelNomAkkFrage? get _current => _atEnd ? null : _queue.first;

  String _previewLine(PossessivartikelNomAkkFrage q) {
  ...
  void _select(int i) {
    ...
    recordGrammarAnswer(
      module: GrammarStatsModule.possessivartikelNomAkk,
      ok: ok,
      options: q.options,
