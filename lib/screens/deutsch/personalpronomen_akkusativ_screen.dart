...
class PersonalpronomenAkkusativScreen extends StatefulWidget {
  const PersonalpronomenAkkusativScreen({super.key});

  @override
  State<PersonalpronomenAkkusativScreen> createState() =>
      _PersonalpronomenAkkusativScreenState();
}

class _PersonalpronomenAkkusativScreenState
    extends State<PersonalpronomenAkkusativScreen>
    with SingleTickerProviderStateMixin {
  late TabController _tabs;
  late List<PersonalpronomenAkkFrage> _queue;
  ...
  void initState() {
    ...
    _queue = List<PersonalpronomenAkkFrage>.from(allPersonalpronomenAkkFragen());
  ...
  PersonalpronomenAkkFrage? get _current => _atEnd ? null : _queue.first;

  String _previewLine(PersonalpronomenAkkFrage q) {
  ...
  void _select(int i) {
    ...
    recordGrammarAnswer(
      module: GrammarStatsModule.personalpronomenAkkusativ,
      ok: ok,
      options: q.options,
