...
class _AkkusativArtikelScreenState extends State<AkkusativArtikelScreen>
  ...
  late List<AkkusativArtikelFrage> _fragen;
  int _qIndex = 0;
  int? _picked;
  ...
  void initState() {
    ...
    _fragen = allAkkusativArtikelFragen();
  }
  ...
  AkkusativArtikelFrage? get _current => _atEnd ? null : _fragen[_qIndex];
      ...
      appBar: AppBar(
        ...
        bottom: TabBar(
          ...
          tabs: [
            ...
            Tab(text: 'Fragen (${_fragen.length})'),
          ],
        ),
      ),
      body: TabBarView(
  ...
  Widget _buildFragenTab(BuildContext context) {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 16),
              Text(
                'Alle ${_fragen.length} Aufgaben durch',
                style: Theme.of(context).textTheme.titleLarge,
              ),
              const SizedBox(height: 12),
              const Text(
                'Сверьтесь с разделом «Теория» (шкала и ответы после каждого шага).',
    ...
    return Column(
      children: [
        LinearProgressIndicator(value: (_qIndex + 1) / _fragen.length),
        Expanded(
          child: ListView(
            ...
            children: [
              ...
              Chip(
                label: Text(
                  '${akkusativArtikelTeilLabelDe(q.teil)} · Nr. ${q.nr}/${_fragen.length}',
                ),
              ...
              child: Padding(
                ...
                child: SizedBox(
                  ...
                  child: FilledButton(
                    onPressed: _nextQ,
                    child: Text(
                      _qIndex + 1 >= _fragen.length ? 'Fertig' : 'Weiter',
                    ),
                  ),
                ),
              ),
