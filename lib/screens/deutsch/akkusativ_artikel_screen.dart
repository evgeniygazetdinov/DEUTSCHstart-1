...
class _AkkusativArtikelScreenState extends State<AkkusativArtikelScreen>
  ...
  void _select(int i) {
    ...
    recordGrammarAnswer(
      module: GrammarStatsModule.akkusativArtikel,
      ok: ok,
      options: q.options,
  ...
  Widget _buildTheoryTab(BuildContext context) {
    return TheoryTabContent(
      headline: 'Artikel im Akkusativ',
      intro: context.s.akkTheoryIntro,
      sections: kAkkusativArtikelTheorySections,
    );
  }
  ...
  Widget _buildFragenTab(BuildContext context) {
    ...
    if (_atEnd) {
      ...
      final fb = context.s.artikelFeedback(p, ArtikelStatsModul.akkusativ);
      return Center(
      ...
      children: [
        ...
        Expanded(
          child: ListView(
            ...
            children: [
              Text(
                context.s.theoryHintQueueRetry,
                style: Theme.of(context).textTheme.bodySmall?.copyWith(
                      color: scheme.onSurfaceVariant,
                    ),
              ),
              ...
              Chip(
                label: Text(
                  context.s.chipProgress(
                    akkusativArtikelTeilLabelDe(q.teil),
                    q.nr,
                    _zielAnzahl,
                    _queue.length,
                  ),
